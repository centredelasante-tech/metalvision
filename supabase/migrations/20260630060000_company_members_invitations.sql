-- Migration: company_members_invitations
...
-- Any authenticated user can create a company (they become owner separately)
...
-- Members can view all colleagues in their company
...
-- Members can view invitations for their company
...
-- Only owners can update invitations (e.g. revoke)
