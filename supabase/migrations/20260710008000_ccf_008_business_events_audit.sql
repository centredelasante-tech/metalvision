...
-- ════════════════════════════════════════════════════════════
-- L'ordre d'application 004 → 008 est garanti par les timestamps
-- de fichiers. Si une table cible est absente (ex. : ccf_003 ou
-- ccf_004 non appliqué), la migration DOIT échouer bruyamment
-- avec une erreur 42P01 — pas continuer silencieusement en laissant
-- une table sans audit trail. Aucun bloc DO/EXCEPTION ici.
-- DROP TRIGGER IF EXISTS est conservé pour l'idempotence (rejeu).
-- ════════════════════════════════════════════════════════════
