...
-- ════════════════════════════════════════════════════════════
-- L'ordre des migrations (004 avant 008) est garanti explicitement
-- par les timestamps. Si une table venait à manquer, la migration
-- doit échouer bruyamment avec une erreur claire, pas continuer
-- silencieusement.
-- ════════════════════════════════════════════════════════════
