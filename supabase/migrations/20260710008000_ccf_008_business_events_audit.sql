...
-- ════════════════════════════════════════════════════════════
-- L'ordre des migrations (003/004/005/006/007 avant 008) est garanti
-- par les timestamps. Les DROP TRIGGER IF EXISTS sont enveloppés dans
-- des blocs DO pour absorber 42P01 lors d'une ré-exécution partielle
-- (idempotence). Les CREATE TRIGGER restent nus : si la table est
-- absente, la migration échoue bruyamment avec une erreur claire.
-- ════════════════════════════════════════════════════════════
