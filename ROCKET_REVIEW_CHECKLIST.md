...
*Dernière mise à jour : 12 juillet 2026, suite à la revue du PR frontend S01/Dashboard (7ᵉ occurrence du patron + réintroduction simultanée d'`INC-S05-02` ET `INC-S09-01` dans des fichiers hors périmètre du brief) — voir ADR-MVP.md §9octodecies.*
