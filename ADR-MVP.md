...
4. Tests end-to-end du parcours CCF complet (organisation → capacité → opportunité → invitation → mandat → projet → documents → logistique → rapport) — validé jusqu'à **projet + invitation + acceptation** inclus : trou de portée E08-T01/T02 trouvé (§9sexvicies), PR corrigée (§9septvicies), `INC-E08-01` trouvé et corrigé au test live (§9octovicies). Projet « consolider Acton Vale » créé, Test no 2 invitée et active. Reste : documents, logistique, rapport de valeur.
