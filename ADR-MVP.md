...
4. Tests end-to-end du parcours CCF complet (organisation → capacité → opportunité → invitation → mandat → projet → documents → logistique → rapport) — **bloqué à l'étape projet** : trou de portée E08-T01/T02 trouvé et documenté (§9sexvicies), brief Rocket rédigé, backend confirmé prêt sans migration. Reste à recevoir/revoir la PR Rocket puis reprendre le test là où il s'est arrêté.
